<template>
  <div class="lg:min-w-[1080px]" :style="{ height: clientHeight + 'px' }">
    <NavBar />

    <div
      v-show="store.navView === 'solver'"
      class="flex flex-col lg:flex-row w-full mx-auto max-w-screen-xl"
      style="height: calc(100% - 2.5rem)"
    >
      <SideBar class="lg:h-[calc(100%-2rem)] flex-shrink-0" />

      <div
        class="flex-grow my-4 px-3 lg:px-6 pt-2 overflow-y-auto"
